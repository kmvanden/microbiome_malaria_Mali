...
# mixOmics
# missing/zero values replaced by 1/5 of the minimum positive value for each variable
...
pdf("metabo_sPLSDA_tune.pdf", width = 10, height = 10)
...
perf.splsda.mali = perf(splsda.mali, folds = 8, validation = "Mfold",
                        dist = "centroids.dist", nrepeat = 50)

perf.splsda.mali$error.rate # error rate for each component
# overall error rate for component 1: 0.4262500

perf.splsda.mali$error.rate.class # error rate per class
# error rate for resistant + component 1: 0.5175
# error rate for susceptible + component 1: 0.3350
...
# output the metabolites selected for a given component and their loading values 
...
plotVar(splsda.mali, comp = c(1,2), var.names = TRUE, # to see names of metabolites clearly
        style = "graphics", legend = TRUE,
        pch = 1, cex = 0.5, col = "deepskyblue3", # shape, size and color of the points
        cutoff = 0.35 # correlation coefficient cut-off
)
...
pdf("auroc_comp1.pdf", width = 5, height = 5)
auroc(splsda.mali, roc.comp = 1)
dev.off()
# AUC for comp1 is 0.7986
# p-value: 0.0003903
...
# [5] BiocManager_1.30.20 phyloseq_1.40.0    
# 
# loaded via a namespace (and not attached):
#   [1] nlme_3.1-162                bitops_1.0-7                matrixStats_1.0.0          
# [4] bit64_4.0.5                 RColorBrewer_1.1-3          httr_1.4.6                 
# [7] GenomeInfoDb_1.32.4         tools_4.2.1                 utf8_1.2.3                 
# [10] R6_2.5.1                    vegan_2.6-4                 DBI_1.1.3                  
# [13] BiocGenerics_0.42.0         mgcv_1.8-42                 colorspace_2.1-0           
# [16] permute_0.9-7               rhdf5filters_1.8.0          ade4_1.7-22                
# [19] withr_2.5.0                 tidyselect_1.2.0            gridExtra_2.3              
# [22] DESeq2_1.36.0               bit_4.0.5                   compiler_4.2.1             
# [25] cli_3.6.1                   Biobase_2.56.0              DelayedArray_0.22.0        
# [28] labeling_0.4.2              scales_1.2.1                genefilter_1.78.0          
# [31] stringr_1.5.0               digest_0.6.31               XVector_0.36.0             
# [34] pkgconfig_2.0.3             MatrixGenerics_1.8.1        fastmap_1.1.1              
# [37] rlang_1.1.1                 rstudioapi_0.15.0           RSQLite_2.3.1              
# [40] farver_2.1.1                generics_0.1.3              jsonlite_1.8.5             
# [43] BiocParallel_1.30.4         dplyr_1.1.2                 RCurl_1.98-1.12            
# [46] magrittr_2.0.3              GenomeInfoDbData_1.2.8      biomformat_1.24.0          
# [49] Matrix_1.5-4.1              Rcpp_1.0.10                 munsell_0.5.0              
# [52] S4Vectors_0.34.0            Rhdf5lib_1.18.2             fansi_1.0.4                
# [55] ape_5.7-1                   lifecycle_1.0.3             stringi_1.7.12             
# [58] SummarizedExperiment_1.26.1 zlibbioc_1.42.0             rhdf5_2.40.0               
# [61] plyr_1.8.8                  grid_4.2.1                  blob_1.2.4                 
# [64] parallel_4.2.1              ggrepel_0.9.3               crayon_1.5.2               
# [67] Biostrings_2.64.1           splines_4.2.1               multtest_2.52.0            
# [70] annotate_1.74.0             KEGGREST_1.36.3             locfit_1.5-9.7             
# [73] pillar_1.9.0                igraph_1.4.3                GenomicRanges_1.48.0       
# [76] corpcor_1.6.10              geneplotter_1.74.0          reshape2_1.4.4             
# [79] codetools_0.2-19            stats4_4.2.1                XML_3.99-0.14              
# [82] glue_1.6.2                  data.table_1.14.8           png_0.1-8                  
# [85] vctrs_0.6.3                 foreach_1.5.2               purrr_1.0.2                
# [88] tidyr_1.3.0                 gtable_0.3.3                cachem_1.0.8               
# [91] xtable_1.8-4                RSpectra_0.16-1             survival_3.5-5             
# [94] rARPACK_0.11-0              tibble_3.2.1                iterators_1.0.14           
# [97] AnnotationDbi_1.58.0        memoise_2.0.1               IRanges_2.30.1             
# [100] ellipse_0.4.5               cluster_2.1.4   
